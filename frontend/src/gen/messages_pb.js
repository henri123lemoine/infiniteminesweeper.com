...
export const ms = $root.ms = (() => {
    ...
    ms.Flag = (function() {
         ...
         * @property {number|null} [flagID] Flag flagID
         */
        ...
        Flag.encode = function encode(message, writer) {
            ...
            if (message.playerId != null && Object.hasOwnProperty.call(message, "playerId"))
                writer.uint32(/* id 4, wireType 0 =*/32).int32(message.playerId);
            if (message.flagID != null && Object.hasOwnProperty.call(message, "flagID"))
                writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.flagID);
            return writer;
        };
    ...
    ms.Hello = (function() {
         ...
         * @property {number|null} [flagID] Hello flagID
         */
        ...
        Hello.encode = function encode(message, writer) {
            ...
            if (message.flagID != null && Object.hasOwnProperty.call(message, "flagID"))
                writer.uint32(/* id 3, wireType 0 =*/24).uint32(message.flagID);
            return writer;
        };
    ...
    ms.Welcome = (function() {
         ...
         * @property {number|null} [flagID] Welcome flagID
