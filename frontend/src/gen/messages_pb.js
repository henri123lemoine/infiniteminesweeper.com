...
export const ms = ($root.ms = (() => {
  ...
  ms.Reveal = (function () {
    ...
    Reveal.verify = function verify(message) {
      ...
      if (message.flow != null && message.hasOwnProperty("flow"))
        if (typeof message.flow !== "boolean") return "flow: boolean expected";
      return null;
    };
    ...
    Reveal.fromObject = function fromObject(object) {
      ...
      if (object.flow != null) message.flow = Boolean(object.flow);
      return message;
    };
  ...
  ms.Subscribe = (function () {
    ...
    Subscribe.verify = function verify(message) {
      ...
      if (message.chunkX != null && message.hasOwnProperty("chunkX"))
        if (!$util.isInteger(message.chunkX)) return "chunkX: integer expected";
      if (message.chunkY != null && message.hasOwnProperty("chunkY"))
        if (!$util.isInteger(message.chunkY)) return "chunkY: integer expected";
      return null;
    };
  ...
  ms.ScoreUpdate = (function () {
    ...
    ScoreUpdate.encode = function encode(message, writer) {
      ...
      if (
        message.worldX != null &&
        Object.hasOwnProperty.call(message, "worldX")
      )
        writer.uint32(/* id 2, wireType 0 =*/ 16).int32(message.worldX);
      if (
        message.worldY != null &&
        Object.hasOwnProperty.call(message, "worldY")
      )
    ...
    ScoreUpdate.verify = function verify(message) {
      ...
      if (message.worldX != null && message.hasOwnProperty("worldX"))
        if (!$util.isInteger(message.worldX)) return "worldX: integer expected";
      if (message.worldY != null && message.hasOwnProperty("worldY"))
        if (!$util.isInteger(message.worldY)) return "worldY: integer expected";
    ...
    ScoreUpdate.fromObject = function fromObject(object) {
      ...
      if (object.worldX != null) message.worldX = object.worldX | 0;
      if (object.worldY != null) message.worldY = object.worldY | 0;
