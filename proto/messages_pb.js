  ...
  $root.ms = (function () {
    ...
    ms.ChunkID = (function () {
      ...
      ChunkID.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.ChunkID) return object;
    ...
    ms.Reveal = (function () {
      ...
      Reveal.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (
          message.chunkId != null &&
          Object.hasOwnProperty.call(message, "chunkId")
        )
          $root.ms.ChunkID.encode(
            message.chunkId,
      ...
      Reveal.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.Reveal();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            case 1: {
              message.chunkId = $root.ms.ChunkID.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      Reveal.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Reveal) return object;
    ...
    ms.Flag = (function () {
      ...
      Flag.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Flag) return object;
    ...
    ms.Hello = (function () {
      ...
      Hello.encode = function encode(message, writer) {
        ...
        if (
          message.viewX != null &&
          Object.hasOwnProperty.call(message, "viewX")
        )
          writer.uint32(/* id 4, wireType 0 =*/ 32).int32(message.viewX);
        if (
          message.viewY != null &&
          Object.hasOwnProperty.call(message, "viewY")
        )
      ...
      Hello.verify = function verify(message) {
        ...
        if (message.viewX != null && message.hasOwnProperty("viewX"))
          if (!$util.isInteger(message.viewX)) return "viewX: integer expected";
        if (message.viewY != null && message.hasOwnProperty("viewY"))
          if (!$util.isInteger(message.viewY)) return "viewY: integer expected";
        return null;
      };
      ...
      Hello.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Hello) return object;
    ...
    ms.Welcome = (function () {
      ...
      Welcome.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Welcome) return object;
    ...
    ms.Subscribe = (function () {
      ...
      Subscribe.encode = function encode(message, writer) {
        ...
        if (
          message.chunkX != null &&
          Object.hasOwnProperty.call(message, "chunkX")
        )
          writer.uint32(/* id 1, wireType 0 =*/ 8).int32(message.chunkX);
        if (
          message.chunkY != null &&
          Object.hasOwnProperty.call(message, "chunkY")
        )
      ...
      Subscribe.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Subscribe) return object;
        var message = new $root.ms.Subscribe();
        if (object.chunkX != null) message.chunkX = object.chunkX | 0;
        if (object.chunkY != null) message.chunkY = object.chunkY | 0;
        return message;
      };
    ...
    ms.Unsubscribe = (function () {
      ...
      Unsubscribe.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.Unsubscribe();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      Unsubscribe.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Unsubscribe) return object;
    ...
    ms.ChunkSync = (function () {
          ...
          switch (tag >>> 3) {
            ...
            case 3: {
              if (!(message.reveals && message.reveals.length))
                message.reveals = [];
              message.reveals.push(
                $root.ms.Reveal.decode(reader, reader.uint32()),
              );
              break;
            }
            case 4: {
      ...
      ChunkSync.verify = function verify(message) {
        ...
        if (message.reveals != null && message.hasOwnProperty("reveals")) {
          if (!Array.isArray(message.reveals)) return "reveals: array expected";
          for (var i = 0; i < message.reveals.length; ++i) {
            var error = $root.ms.Reveal.verify(message.reveals[i]);
            if (error) return "reveals." + error;
          }
        }
        if (message.flags != null && message.hasOwnProperty("flags")) {
          if (!Array.isArray(message.flags)) return "flags: array expected";
          for (var i = 0; i < message.flags.length; ++i) {
            var error = $root.ms.Flag.verify(message.flags[i]);
      ...
      ChunkSync.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.ChunkSync) return object;
      ...
      ChunkSync.toObject = function toObject(message, options) {
        ...
        if (message.reveals && message.reveals.length) {
          ...
          for (var j = 0; j < message.reveals.length; ++j)
            object.reveals[j] = $root.ms.Reveal.toObject(
              message.reveals[j],
              options,
            );
        }
    ...
    ms.RevealAck = (function () {
      ...
      RevealAck.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.RevealAck) return object;
    ...
    ms.FlagAck = (function () {
      ...
      FlagAck.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.FlagAck) return object;
    ...
    ms.LeaderboardEntry = (function () {
       ...
       * @returns {$protobuf.Writer} Writer
       */
      LeaderboardEntry.encodeDelimited = function encodeDelimited(
        message,
        writer,
      ) {
        return this.encode(message, writer).ldelim();
      ...
      LeaderboardEntry.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.LeaderboardEntry();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      LeaderboardEntry.verify = function verify(message) {
        ...
        if (message.score != null && message.hasOwnProperty("score"))
          if (!$util.isString(message.score)) return "score: string expected";
        return null;
      };
      ...
      LeaderboardEntry.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.LeaderboardEntry) return object;
    ...
    ms.Leaderboard = (function () {
       ...
       * @instance
       */
      Leaderboard.prototype.version = $util.Long
      ...
      Leaderboard.encode = function encode(message, writer) {
        ...
        if (message.entries != null && message.entries.length)
          for (var i = 0; i < message.entries.length; ++i)
            $root.ms.LeaderboardEntry.encode(
              message.entries[i],
      ...
      Leaderboard.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.Leaderboard();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
            ...
            case 2: {
              ...
              message.entries.push(
                $root.ms.LeaderboardEntry.decode(reader, reader.uint32()),
              );
              break;
            }
            default:
      ...
      Leaderboard.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Leaderboard) return object;
        ...
        if (object.entries) {
          ...
          for (var i = 0; i < object.entries.length; ++i) {
            ...
            message.entries[i] = $root.ms.LeaderboardEntry.fromObject(
              object.entries[i],
            );
          }
        }
      ...
      Leaderboard.toObject = function toObject(message, options) {
        ...
        if (message.entries && message.entries.length) {
          ...
          for (var j = 0; j < message.entries.length; ++j)
            object.entries[j] = $root.ms.LeaderboardEntry.toObject(
              message.entries[j],
              options,
            );
        }
    ...
    ms.ScoreUpdate = (function () {
      ...
      ScoreUpdate.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.ScoreUpdate();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      ScoreUpdate.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.ScoreUpdate) return object;
      ...
      ScoreUpdate.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.defaults) object.score = 0;
        if (message.score != null && message.hasOwnProperty("score"))
          object.score = message.score;
        return object;
      };
    ...
    ms.ViewUpdate = (function () {
      ...
      ViewUpdate.decode = function decode(reader, length, error) {
        if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length,
          message = new $root.ms.ViewUpdate();
        while (reader.pos < end) {
          var tag = reader.uint32();
          if (tag === error) break;
          switch (tag >>> 3) {
      ...
      ViewUpdate.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.ViewUpdate) return object;
        var message = new $root.ms.ViewUpdate();
        if (object.viewX != null) message.viewX = object.viewX | 0;
        if (object.viewY != null) message.viewY = object.viewY | 0;
        return message;
      };
    ...
    ms.Msg = (function () {
      ...
      Msg.encode = function encode(message, writer) {
        ...
        if (
          message.hello != null &&
          Object.hasOwnProperty.call(message, "hello")
        )
          $root.ms.Hello.encode(
            message.hello,
            writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
          ).ldelim();
        if (
          message.welcome != null &&
          Object.hasOwnProperty.call(message, "welcome")
        )
          $root.ms.Welcome.encode(
            message.welcome,
            writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
          ).ldelim();
        if (
          message.reveal != null &&
          Object.hasOwnProperty.call(message, "reveal")
        )
          $root.ms.Reveal.encode(
            message.reveal,
            writer.uint32(/* id 3, wireType 2 =*/ 26).fork(),
        ...
        if (
          ...
          $root.ms.Unsubscribe.encode(
            message.unsubscribe,
            writer.uint32(/* id 6, wireType 2 =*/ 50).fork(),
          ).ldelim();
        if (
          message.chunkSync != null &&
          Object.hasOwnProperty.call(message, "chunkSync")
        )
          $root.ms.ChunkSync.encode(
            message.chunkSync,
            writer.uint32(/* id 7, wireType 2 =*/ 58).fork(),
          ).ldelim();
        if (
          message.revealAck != null &&
          Object.hasOwnProperty.call(message, "revealAck")
        )
          $root.ms.RevealAck.encode(
            message.revealAck,
            writer.uint32(/* id 8, wireType 2 =*/ 66).fork(),
          ).ldelim();
        if (
          message.flagAck != null &&
          Object.hasOwnProperty.call(message, "flagAck")
        )
          $root.ms.FlagAck.encode(
            message.flagAck,
            writer.uint32(/* id 9, wireType 2 =*/ 74).fork(),
          ).ldelim();
        if (
          message.leaderboard != null &&
          Object.hasOwnProperty.call(message, "leaderboard")
        )
          $root.ms.Leaderboard.encode(
            message.leaderboard,
            writer.uint32(/* id 10, wireType 2 =*/ 82).fork(),
          ).ldelim();
        if (
          message.scoreUpdate != null &&
          Object.hasOwnProperty.call(message, "scoreUpdate")
        )
          $root.ms.ScoreUpdate.encode(
            message.scoreUpdate,
            writer.uint32(/* id 11, wireType 2 =*/ 90).fork(),
          ).ldelim();
        if (
          message.viewUpdate != null &&
          Object.hasOwnProperty.call(message, "viewUpdate")
        )
          $root.ms.ViewUpdate.encode(
            message.viewUpdate,
      ...
      Msg.decode = function decode(reader, length, error) {
        ...
        while (reader.pos < end) {
          ...
          switch (tag >>> 3) {
            ...
            case 2: {
              message.welcome = $root.ms.Welcome.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 5: {
              message.subscribe = $root.ms.Subscribe.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 6: {
              message.unsubscribe = $root.ms.Unsubscribe.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 7: {
              message.chunkSync = $root.ms.ChunkSync.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 8: {
              message.revealAck = $root.ms.RevealAck.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 9: {
              message.flagAck = $root.ms.FlagAck.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 10: {
              message.leaderboard = $root.ms.Leaderboard.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 11: {
              message.scoreUpdate = $root.ms.ScoreUpdate.decode(
                reader,
                reader.uint32(),
              );
              break;
            ...
            case 12: {
              message.viewUpdate = $root.ms.ViewUpdate.decode(
                reader,
                reader.uint32(),
              );
              break;
      ...
      Msg.verify = function verify(message) {
        ...
        if (message.chunkSync != null && message.hasOwnProperty("chunkSync")) {
          ...
          properties.payload = 1;
          {
            ...
            if (error) return "chunkSync." + error;
          }
        }
        if (message.revealAck != null && message.hasOwnProperty("revealAck")) {
          ...
          properties.payload = 1;
          {
            ...
            if (error) return "revealAck." + error;
          }
        }
        if (message.flagAck != null && message.hasOwnProperty("flagAck")) {
          ...
          properties.payload = 1;
          {
            ...
            if (error) return "flagAck." + error;
          }
        }
        if (
          message.leaderboard != null &&
          message.hasOwnProperty("leaderboard")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
        ...
        if (
          message.scoreUpdate != null &&
          message.hasOwnProperty("scoreUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            var error = $root.ms.ScoreUpdate.verify(message.scoreUpdate);
            if (error) return "scoreUpdate." + error;
          }
        }
        if (
          message.viewUpdate != null &&
          message.hasOwnProperty("viewUpdate")
        ) {
          if (properties.payload === 1) return "payload: multiple values";
          properties.payload = 1;
          {
            var error = $root.ms.ViewUpdate.verify(message.viewUpdate);
            if (error) return "viewUpdate." + error;
          }
        }
        return null;
      };
      ...
      Msg.fromObject = function fromObject(object) {
        if (object instanceof $root.ms.Msg) return object;
        ...
        if (object.unsubscribe != null) {
          ...
          message.unsubscribe = $root.ms.Unsubscribe.fromObject(
            object.unsubscribe,
          );
        }
        ...
        if (object.leaderboard != null) {
          ...
          message.leaderboard = $root.ms.Leaderboard.fromObject(
            object.leaderboard,
          );
        }
        if (object.scoreUpdate != null) {
          ...
          message.scoreUpdate = $root.ms.ScoreUpdate.fromObject(
            object.scoreUpdate,
          );
        }
        if (object.viewUpdate != null) {
          ...
          message.viewUpdate = $root.ms.ViewUpdate.fromObject(
            object.viewUpdate,
          );
        }
        return message;
      ...
      Msg.toObject = function toObject(message, options) {
        ...
        if (message.hello != null && message.hasOwnProperty("hello")) {
          ...
          if (options.oneofs) object.payload = "hello";
        }
        if (message.welcome != null && message.hasOwnProperty("welcome")) {
          object.welcome = $root.ms.Welcome.toObject(message.welcome, options);
          if (options.oneofs) object.payload = "welcome";
        }
        if (message.reveal != null && message.hasOwnProperty("reveal")) {
          object.reveal = $root.ms.Reveal.toObject(message.reveal, options);
          if (options.oneofs) object.payload = "reveal";
        }
        if (message.flag != null && message.hasOwnProperty("flag")) {
          object.flag = $root.ms.Flag.toObject(message.flag, options);
          if (options.oneofs) object.payload = "flag";
        }
        if (message.subscribe != null && message.hasOwnProperty("subscribe")) {
          object.subscribe = $root.ms.Subscribe.toObject(
            message.subscribe,
            options,
          );
          if (options.oneofs) object.payload = "subscribe";
        }
        if (
          message.unsubscribe != null &&
          message.hasOwnProperty("unsubscribe")
        ) {
          object.unsubscribe = $root.ms.Unsubscribe.toObject(
            message.unsubscribe,
            options,
          );
          if (options.oneofs) object.payload = "unsubscribe";
        }
        if (message.chunkSync != null && message.hasOwnProperty("chunkSync")) {
          object.chunkSync = $root.ms.ChunkSync.toObject(
            message.chunkSync,
            options,
          );
          if (options.oneofs) object.payload = "chunkSync";
        }
        if (message.revealAck != null && message.hasOwnProperty("revealAck")) {
          object.revealAck = $root.ms.RevealAck.toObject(
            message.revealAck,
            options,
          );
          if (options.oneofs) object.payload = "revealAck";
        }
        if (message.flagAck != null && message.hasOwnProperty("flagAck")) {
          object.flagAck = $root.ms.FlagAck.toObject(message.flagAck, options);
          if (options.oneofs) object.payload = "flagAck";
        }
        if (
          message.leaderboard != null &&
          message.hasOwnProperty("leaderboard")
        ) {
          object.leaderboard = $root.ms.Leaderboard.toObject(
            message.leaderboard,
            options,
          );
          if (options.oneofs) object.payload = "leaderboard";
        }
        if (
          message.scoreUpdate != null &&
          message.hasOwnProperty("scoreUpdate")
        ) {
          object.scoreUpdate = $root.ms.ScoreUpdate.toObject(
            message.scoreUpdate,
            options,
          );
          if (options.oneofs) object.payload = "scoreUpdate";
        }
        if (
          message.viewUpdate != null &&
          message.hasOwnProperty("viewUpdate")
        ) {
          object.viewUpdate = $root.ms.ViewUpdate.toObject(
            message.viewUpdate,
            options,
          );
          if (options.oneofs) object.payload = "viewUpdate";
        }
        return object;
      };
