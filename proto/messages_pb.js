...
$root.ms = (function() {
    ...
    ms.Welcome = (function() {
        ...
        Welcome.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.Welcome)
                return object;
            var message = new $root.ms.Welcome();
            if (object.playerId != null)
                message.playerId = object.playerId | 0;
            if (object.name != null)
                message.name = String(object.name);
    ...
    ms.FlagLocation = (function() {

        /**
         * Properties of a FlagLocation.
         * @memberof ms
         * @interface IFlagLocation
         * @property {number|null} [x] FlagLocation x
         * @property {number|null} [y] FlagLocation y
         */

        /**
         * Constructs a new FlagLocation.
         * @memberof ms
         * @classdesc Represents a FlagLocation.
         * @implements IFlagLocation
         * @constructor
         * @param {ms.IFlagLocation=} [properties] Properties to set
         */
        function FlagLocation(properties) {
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
                        this[keys[i]] = properties[keys[i]];
         ...
         * FlagLocation x.
         * @member {number} x
         * @memberof ms.FlagLocation
         * @instance
         */
        FlagLocation.prototype.x = 0;
         ...
         * @instance
         */
        FlagLocation.prototype.y = 0;

        /**
         * Creates a new FlagLocation instance using the specified properties.
         * @function create
         * @memberof ms.FlagLocation
         * @static
         * @param {ms.IFlagLocation=} [properties] Properties to set
         * @returns {ms.FlagLocation} FlagLocation instance
         */
        FlagLocation.create = function create(properties) {
            return new FlagLocation(properties);
        };

        /**
         * Encodes the specified FlagLocation message. Does not implicitly {@link ms.FlagLocation.verify|verify} messages.
         * @function encode
         * @memberof ms.FlagLocation
         * @static
         * @param {ms.IFlagLocation} message FlagLocation message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        FlagLocation.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.x != null && Object.hasOwnProperty.call(message, "x"))
                writer.uint32(/* id 1, wireType 0 =*/8).int32(message.x);
        ...
        /**
         * Encodes the specified FlagLocation message, length delimited. Does not implicitly {@link ms.FlagLocation.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ms.FlagLocation
         * @static
         * @param {ms.IFlagLocation} message FlagLocation message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FlagLocation.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a FlagLocation message from the specified reader or buffer.
         * @function decode
         * @memberof ms.FlagLocation
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ms.FlagLocation} FlagLocation
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlagLocation.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ms.FlagLocation();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        /**
         * Decodes a FlagLocation message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ms.FlagLocation
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlagLocation.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a FlagLocation message.
         * @function verify
         * @memberof ms.FlagLocation
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FlagLocation.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.x != null && message.hasOwnProperty("x"))
                if (!$util.isInteger(message.x))
        ...
        /**
         * Creates a FlagLocation message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ms.FlagLocation
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ms.FlagLocation} FlagLocation
         */
        FlagLocation.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.FlagLocation)
                return object;
            var message = new $root.ms.FlagLocation();
            if (object.x != null)
                message.x = object.x | 0;
            if (object.y != null)
                message.y = object.y | 0;
        ...
        /**
         * Creates a plain object from a FlagLocation message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ms.FlagLocation
         * @static
         * @param {ms.FlagLocation} message FlagLocation
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        FlagLocation.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
        ...
        /**
         * Converts this FlagLocation to JSON.
         * @function toJSON
         * @memberof ms.FlagLocation
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        FlagLocation.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for FlagLocation
         * @function getTypeUrl
         * @memberof ms.FlagLocation
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        FlagLocation.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/ms.FlagLocation";
        };

        return FlagLocation;
    })();

    ms.FlagGroup = (function() {

        /**
         * Properties of a FlagGroup.
         * @memberof ms
         * @interface IFlagGroup
         * @property {string|null} [color] FlagGroup color
         * @property {number|null} [playerId] FlagGroup playerId
         * @property {Array.<ms.IFlagLocation>|null} [locations] FlagGroup locations
         */

        /**
         * Constructs a new FlagGroup.
         * @memberof ms
         * @classdesc Represents a FlagGroup.
         * @implements IFlagGroup
         * @constructor
         * @param {ms.IFlagGroup=} [properties] Properties to set
         */
        function FlagGroup(properties) {
            this.locations = [];
            if (properties)
                for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                    if (properties[keys[i]] != null)
         ...
         * FlagGroup color.
         * @member {string} color
         * @memberof ms.FlagGroup
         * @instance
         */
        FlagGroup.prototype.color = "";
         ...
         * @instance
         */
        FlagGroup.prototype.playerId = 0;

        /**
         * FlagGroup locations.
         * @member {Array.<ms.IFlagLocation>} locations
         * @memberof ms.FlagGroup
         * @instance
         */
        FlagGroup.prototype.locations = $util.emptyArray;

        /**
         * Creates a new FlagGroup instance using the specified properties.
         * @function create
         * @memberof ms.FlagGroup
         * @static
         * @param {ms.IFlagGroup=} [properties] Properties to set
         * @returns {ms.FlagGroup} FlagGroup instance
         */
        FlagGroup.create = function create(properties) {
            return new FlagGroup(properties);
        };

        /**
         * Encodes the specified FlagGroup message. Does not implicitly {@link ms.FlagGroup.verify|verify} messages.
         * @function encode
         * @memberof ms.FlagGroup
         * @static
         * @param {ms.IFlagGroup} message FlagGroup message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        FlagGroup.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.color != null && Object.hasOwnProperty.call(message, "color"))
            ...
            if (message.locations != null && message.locations.length)
                for (var i = 0; i < message.locations.length; ++i)
                    $root.ms.FlagLocation.encode(message.locations[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };

        /**
         * Encodes the specified FlagGroup message, length delimited. Does not implicitly {@link ms.FlagGroup.verify|verify} messages.
         * @function encodeDelimited
         * @memberof ms.FlagGroup
         * @static
         * @param {ms.IFlagGroup} message FlagGroup message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FlagGroup.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a FlagGroup message from the specified reader or buffer.
         * @function decode
         * @memberof ms.FlagGroup
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {ms.FlagGroup} FlagGroup
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlagGroup.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ms.FlagGroup();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 3: {
                        if (!(message.locations && message.locations.length))
                            message.locations = [];
                        message.locations.push($root.ms.FlagLocation.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a FlagGroup message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof ms.FlagGroup
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlagGroup.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FlagGroup.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.color != null && message.hasOwnProperty("color"))
                if (!$util.isString(message.color))
            ...
            if (message.locations != null && message.hasOwnProperty("locations")) {
                ...
                for (var i = 0; i < message.locations.length; ++i) {
                    var error = $root.ms.FlagLocation.verify(message.locations[i]);
                    if (error)
        ...
        /**
         * Creates a FlagGroup message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof ms.FlagGroup
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {ms.FlagGroup} FlagGroup
         */
        FlagGroup.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.FlagGroup)
                return object;
            var message = new $root.ms.FlagGroup();
            if (object.color != null)
                message.color = String(object.color);
            if (object.playerId != null)
                message.playerId = object.playerId | 0;
            if (object.locations) {
                if (!Array.isArray(object.locations))
                    throw TypeError(".ms.FlagGroup.locations: array expected");
                message.locations = [];
                for (var i = 0; i < object.locations.length; ++i) {
                    if (typeof object.locations[i] !== "object")
                        throw TypeError(".ms.FlagGroup.locations: object expected");
                    message.locations[i] = $root.ms.FlagLocation.fromObject(object.locations[i]);
                }
            }
            return message;
        };
        ...
        /**
         * Creates a plain object from a FlagGroup message. Also converts values to other types if specified.
         * @function toObject
         * @memberof ms.FlagGroup
         * @static
         * @param {ms.FlagGroup} message FlagGroup
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        FlagGroup.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            ...
            if (message.locations && message.locations.length) {
                ...
                for (var j = 0; j < message.locations.length; ++j)
                    object.locations[j] = $root.ms.FlagLocation.toObject(message.locations[j], options);
            }
            return object;
        };

        /**
         * Converts this FlagGroup to JSON.
         * @function toJSON
         * @memberof ms.FlagGroup
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        FlagGroup.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for FlagGroup
         * @function getTypeUrl
         * @memberof ms.FlagGroup
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        FlagGroup.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/ms.FlagGroup";
        };
    ...
    ms.ChunkSync = (function() {
         ...
         * @property {Uint8Array|null} [reveals] ChunkSync reveals
         * @property {Array.<ms.IFlagGroup>|null} [flagGroups] ChunkSync flagGroups
         */
        ...
        /**
         * ChunkSync reveals.
         * @member {Uint8Array} reveals
         * @memberof ms.ChunkSync
         * @instance
         */
        ChunkSync.prototype.reveals = $util.newBuffer([]);

        /**
         * ChunkSync flagGroups.
         * @member {Array.<ms.IFlagGroup>} flagGroups
         * @memberof ms.ChunkSync
         * @instance
         */
        ChunkSync.prototype.flagGroups = $util.emptyArray;
        ...
        ChunkSync.encode = function encode(message, writer) {
            ...
            if (message.reveals != null && Object.hasOwnProperty.call(message, "reveals"))
                writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.reveals);
            if (message.flagGroups != null && message.flagGroups.length)
                for (var i = 0; i < message.flagGroups.length; ++i)
                    $root.ms.FlagGroup.encode(message.flagGroups[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        ChunkSync.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 3: {
                        message.reveals = reader.bytes();
                        break;
                    }
                case 4: {
                        if (!(message.flagGroups && message.flagGroups.length))
                            message.flagGroups = [];
                        message.flagGroups.push($root.ms.FlagGroup.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ChunkSync.verify = function verify(message) {
            ...
            if (message.reveals != null && message.hasOwnProperty("reveals"))
                if (!(message.reveals && typeof message.reveals.length === "number" || $util.isString(message.reveals)))
                    return "reveals: buffer expected";
            if (message.flagGroups != null && message.hasOwnProperty("flagGroups")) {
                if (!Array.isArray(message.flagGroups))
                    return "flagGroups: array expected";
                for (var i = 0; i < message.flagGroups.length; ++i) {
                    var error = $root.ms.FlagGroup.verify(message.flagGroups[i]);
                    if (error)
                        return "flagGroups." + error;
                }
            }
            return null;
        };
        ...
        ChunkSync.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.ChunkSync)
                return object;
            var message = new $root.ms.ChunkSync();
            if (object.chunkId != null) {
                if (typeof object.chunkId !== "object")
            ...
            if (object.reveals != null)
                if (typeof object.reveals === "string")
                    $util.base64.decode(object.reveals, message.reveals = $util.newBuffer($util.base64.length(object.reveals)), 0);
                else if (object.reveals.length >= 0)
                    message.reveals = object.reveals;
            if (object.flagGroups) {
                if (!Array.isArray(object.flagGroups))
                    throw TypeError(".ms.ChunkSync.flagGroups: array expected");
                message.flagGroups = [];
                for (var i = 0; i < object.flagGroups.length; ++i) {
                    if (typeof object.flagGroups[i] !== "object")
                        throw TypeError(".ms.ChunkSync.flagGroups: object expected");
                    message.flagGroups[i] = $root.ms.FlagGroup.fromObject(object.flagGroups[i]);
                }
            }
            return message;
        };
        ...
        ChunkSync.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if (options.bytes === String)
                    ...
                    object.reveals = [];
                    if (options.bytes !== Array)
                        object.reveals = $util.newBuffer(object.reveals);
                }
            }
            if (message.chunkId != null && message.hasOwnProperty("chunkId"))
                object.chunkId = $root.ms.ChunkID.toObject(message.chunkId, options);
            ...
            if (message.reveals != null && message.hasOwnProperty("reveals"))
                object.reveals = options.bytes === String ? $util.base64.encode(message.reveals, 0, message.reveals.length) : options.bytes === Array ? Array.prototype.slice.call(message.reveals) : message.reveals;
            if (message.flagGroups && message.flagGroups.length) {
                object.flagGroups = [];
                for (var j = 0; j < message.flagGroups.length; ++j)
                    object.flagGroups[j] = $root.ms.FlagGroup.toObject(message.flagGroups[j], options);
            }
            return object;
        };
    ...
    ms.RevealAck = (function() {
        ...
        RevealAck.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.RevealAck)
                return object;
            var message = new $root.ms.RevealAck();
            if (object.ok != null)
    ...
    ms.FlagAck = (function() {
        ...
        FlagAck.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.FlagAck)
                return object;
            var message = new $root.ms.FlagAck();
            if (object.ok != null)
                message.ok = Boolean(object.ok);
            return message;
        };
    ...
    ms.LeaderboardEntry = (function() {
        ...
        LeaderboardEntry.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.LeaderboardEntry)
                return object;
            var message = new $root.ms.LeaderboardEntry();
            if (object.playerId != null)
                message.playerId = object.playerId | 0;
            if (object.name != null)
                message.name = String(object.name);
    ...
    ms.Leaderboard = (function() {
        ...
        Leaderboard.verify = function verify(message) {
            ...
            if (message.entries != null && message.hasOwnProperty("entries")) {
                ...
                for (var i = 0; i < message.entries.length; ++i) {
                    var error = $root.ms.LeaderboardEntry.verify(message.entries[i]);
                    if (error)
        ...
        Leaderboard.fromObject = function fromObject(object) {
            if (object instanceof $root.ms.Leaderboard)
                return object;
            var message = new $root.ms.Leaderboard();
    ...
    ms.Msg = (function() {
        ...
        Msg.verify = function verify(message) {
            ...
            if (message.hello != null && message.hasOwnProperty("hello")) {
                ...
                {
                    var error = $root.ms.Hello.verify(message.hello);
                    if (error)
                        return "hello." + error;
                }
            }
            if (message.welcome != null && message.hasOwnProperty("welcome")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Welcome.verify(message.welcome);
                    if (error)
            ...
            if (message.reveal != null && message.hasOwnProperty("reveal")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Reveal.verify(message.reveal);
                    if (error)
                        return "reveal." + error;
                }
            }
            if (message.flag != null && message.hasOwnProperty("flag")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Flag.verify(message.flag);
                    if (error)
                        return "flag." + error;
                }
            }
            if (message.subscribe != null && message.hasOwnProperty("subscribe")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Subscribe.verify(message.subscribe);
                    if (error)
            ...
            if (message.unsubscribe != null && message.hasOwnProperty("unsubscribe")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Unsubscribe.verify(message.unsubscribe);
                    if (error)
            ...
            if (message.chunkSync != null && message.hasOwnProperty("chunkSync")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.ChunkSync.verify(message.chunkSync);
                    if (error)
            ...
            if (message.revealAck != null && message.hasOwnProperty("revealAck")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.RevealAck.verify(message.revealAck);
                    if (error)
            ...
            if (message.flagAck != null && message.hasOwnProperty("flagAck")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.FlagAck.verify(message.flagAck);
                    if (error)
            ...
            if (message.leaderboard != null && message.hasOwnProperty("leaderboard")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.Leaderboard.verify(message.leaderboard);
                    if (error)
            ...
            if (message.scoreUpdate != null && message.hasOwnProperty("scoreUpdate")) {
                ...
                properties.payload = 1;
                {
                    var error = $root.ms.ScoreUpdate.verify(message.scoreUpdate);
                    if (error)
