...
type Reveal struct {
	...
	Flow          bool                   `protobuf:"varint,5,opt,name=flow,proto3" json:"flow,omitempty"` // true if this is a flow reveal request
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_proto_messages_proto_goTypes = []any{
	...
	(*RevealAck)(nil),        // 8: ms.RevealAck
	(*FlagAck)(nil),          // 9: ms.FlagAck
...
var file_proto_messages_proto_depIdxs = []int32{
	...
	10, // 5: ms.Leaderboard.entries:type_name -> ms.LeaderboardEntry
	...
	7,  // 12: ms.Msg.chunkSync:type_name -> ms.ChunkSync
	8,  // 13: ms.Msg.revealAck:type_name -> ms.RevealAck
